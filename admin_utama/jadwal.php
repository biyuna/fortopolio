 		...
 		<?php
 		 ...
 		 ?>
 			...
 			<tr>
 				...
 				<a href = "edit_jadwal.php?kd=<?php echo $data['id_jadwal']; ?>" class="btn btn-warning"> Edit </a>
 				<a onclick="return confirm('Apakah Anda Yakin?')" href= "hapus_jadwal.php?kd=<?php echo $data['id_jadwal']; ?>" class="btn btn-danger"> Hapus </a>
 				</td>
