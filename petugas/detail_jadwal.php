 ...
 $id = $_GET['kd']; 
  ...
  <br><br><br>
 	<table border="1" style="width:600px; border color="black" align="center"><font face="verdana">
 		<tr>
 			<td bgcolor="#6495ED" align="center" style="width:600px;"><font color="#ffffff"> Kode Ruangan </td>
 		...
 		<tr>
 			<td bgcolor="#6495ED" align="center" style="width:600px;"><font color="#ffffff"> Keterangan </td>
 			<td bgcolor="#6495ED"  align="center" style="width:600px;"> <font color="#ffffff"> <?php echo $data['keterangan'] ?> </td>
 		</tr>
